...
export const FilePicker: React.FC<FilePickerProps> = ({
  ...
  const fileItemsStyle =
    "mt-2 flex items-center rounded-lg text-title-md transition-all";
  return (
    <div>
      <div
      ...
      >
        <input
          ...
          {...props}
        />
        <div className="text-title-md flex items-center">
      ...
      {files &&
        files.map((file, index) => (
          <div key={index} className={fileItemsStyle}>
            ...
            <span className="text-body-md mx-2">{file.name}</span>
            <IconButton
              icon="close"
              className="m-1"
