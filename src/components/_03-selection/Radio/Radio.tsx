...
export const Radio = React.forwardRef<HTMLInputElement, RadioProps>(
  (
    ...
    const iconStyle =
      "flex shrink-0 select-none items-center justify-center rounded-full text-title-sm transition-all group-hover:bg-black-5-opacity group-focus-visible:bg-black-5-opacity";
          ...
          {options.map((option, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-body-md ml-1 flex h-full w-full">
                  {option.label}
                  {option.children}
                </div>
              </button>
