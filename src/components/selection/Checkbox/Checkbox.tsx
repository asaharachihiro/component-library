  ...
  (
    ...
    return (
      <CheckboxPrimitive.Root
        id={id}
        className={cn(
          "inline-flex h-7 w-7 select-none items-center justify-center rounded-md text-2xl hover:bg-black-5-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-black-sub active:bg-black-10-opacity",
          disabledStyle,
          errorStyle,
          className
        )}
